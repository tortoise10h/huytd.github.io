...
From here, you can continue customizing Emacs as you need, for example, add [[https://github.com/bbatsov/projectile][projectile]] package for project management, add more language supports, customize your mode line,...
